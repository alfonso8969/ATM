    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12" id="screenView">
          <!-- Place <h1></h1> below -->
          <h1 class="demo-section-title text-uppercase text-center">Opciones de la cuenta</h1>
          ...
          <br />
           <div class="row">
            ...
            <div class="col-xs-9">
                <div class="col-xs-12">
                  <div class="tile" onclick="location.href='account_movements.jsp'">
                   <h4 class="text-uppercase balance"><span>Saldo</span>${ sessionScope.account.balance }&euro;</h4>
                   <h6 class="text-uppercase"><span>Ver movimientos</span></h6>
                  </div>
                </div>
            <!-- Options -->
                <div class="col-xs-4">
                  <div class="tile" onclick="location.href='account_deposit.jsp'">
                    <img src="${pageContext.request.contextPath}/resources/img/deposit_vault.png" alt="Make a Deposit" class="tile-image big-illustration">
                ...
                <div class="col-xs-4">
                  <div class="tile" onclick="location.href='account_withdrawl.jsp'">
                    <img src="${pageContext.request.contextPath}/resources/img/quick_cash.png" alt="Withdraw Funds" class="tile-image">
                ...
                <div class="col-xs-4">
                  <div class="tile"  onclick="location.href='doGetAccounts'">
                    <img src="${pageContext.request.contextPath}/resources/img/transfer_money.png" alt="Transfer Funds to Another Account" class="tile-image">
            ...
            <div class="col-xs-3">
              <div class="tile">
               <a id="back" href="topin" class="btn btn-lg btn-inverse text-uppercase btn-padding"><span class="fui-arrow-left"></span>Volver</a>
              </div>
              <div class="tile">
      ...
      <div class="col-xs-12">
        <h2>
            <blockquote>Este sistema de cajero autom&aacute;tico es solo para pruebas de software! --- <a href="#">Alf&copy; 2021</a></blockquote>
        </h2>
    </div>
  </div><!-- // END row-->
