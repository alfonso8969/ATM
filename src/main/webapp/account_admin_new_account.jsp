...
<head>
  <meta charset="utf-8">
  <title>Cajero Admin: Nueva Cuenta</title>
    <!-- Font Awesome -->
  <link
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12" id="screenView">
        <h1 class="demo-section-title text-uppercase text-center">Administraci&oacute;n: Nueva Cuenta</h1>
                ...
                <div class="row mb-4" style="margin-left: -0.75rem!important;">
                  <div class="col">
                    ...
                    <div class="form-outline mt-4">
	                  ...
	                  <label class="form-label" for="balance">Saldo inicial (opcional)</label>
	                </div>
                  </div>
				</div>
                <!-- Checkbox -->
                <div class="form-check d-flex justify-content-center mb-4">
                  <label class="form-check-label" for="checkAcccount">Crear cuenta</label>
                </div>
