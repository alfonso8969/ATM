...
<head>
  <meta charset="utf-8">
  <title>Cajero Admin: Nuevo Cliente</title>
    <!-- Font Awesome -->
  <link
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12" id="screenView">
        <h1 class="demo-section-title text-uppercase text-center">Administraci&oacute;n: Nuevo Cliente</h1>
        ...
        <div class="row">
          ...
          <div class="col-xs-9 adm">
            <div class="row">
              <f:form action="doNewClient" method="post" modelAttribute="client" onsubmit="return validate()">
                ...
                <div class="form-check d-flex justify-content-center mb-4">
                  <label class="form-check-label" for="checkAcccount">Crear cuenta cliente</label>
                </div>
